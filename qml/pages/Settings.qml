...
QtObject {
    ...
    property bool webview_swipe_back_enabled_value: Settings.value(webview_swipe_back_enabled, "true") === "true"
    ...
    onQuestion_view_page_font_size_valueChanged: Settings.setValue(question_view_page_font_size, question_view_page_font_size_value)
    ...
    onQuestion_list_show_tags_valueChanged: Settings.setValue(question_list_show_tags, question_list_show_tags_value)
    onQuestion_list_show_separator_line_valueChanged: Settings.setValue(question_list_show_separator_line, question_list_show_separator_line_value)
}
